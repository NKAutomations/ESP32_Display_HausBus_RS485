...
void create_screen_main() {
    ...
    lv_obj_set_size(obj, 800, 480);
    {
        lv_obj_t *parent_obj = obj;
        {
            ...
            lv_label_set_text_static(obj, "Waveshare43_b_Hausbus_RS485_SPS_HMI");
        }
        {
            // btn_1
        ...
        }
        {
            ...
            lv_obj_set_pos(obj, 681, 422);
            lv_obj_set_size(obj, 119, 58);
